...
//Add durations taxonomy
add_action( 'init', 'create_durations_hierarchical_taxonomy', 0 );

function create_durations_hierarchical_taxonomy() {

    $labels = array(
        'name' => _x( 'Durations', 'taxonomy general name' ),
        'singular_name' => _x( 'Duration', 'taxonomy singular' ),
...
// Register the durations taxonomy

    register_taxonomy('durations',array('post'), array(
        'hierarchical' => true,
        'labels' => $labels,
        'show_ui' => true,
...
//Add durations taxonomy
add_action( 'init', 'create_employmenttypes_hierarchical_taxonomy', 0 );

function create_employmenttypes_hierarchical_taxonomy() {

    $labels = array(
        'name' => _x( 'Employment Types', 'taxonomy general name' ),
        'singular_name' => _x( 'Employment Type', 'taxonomy singular' ),
        'search_items' =>  __( 'Search Employment Types' ),
        'all_items' => __( 'All Employment Types' ),
        ...
        'new_item_name' => __( 'New Employment Type' ),
        'menu_name' => __( 'Employment Types' ),
    );

// Register the employmenttypes taxonomy

    register_taxonomy('employmenttypes',array('post'), array(
        'hierarchical' => true,
        'labels' => $labels,
        'show_ui' => true,
        'show_admin_column' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => 'employmenttypes' ),
    ));
...
//Add fields taxonomy
add_action( 'init', 'create_fields_hierarchical_taxonomy', 0 );

function create_fields_hierarchical_taxonomy() {

    $labels = array(
        'name' => _x( 'Fields', 'taxonomy general name' ),
        'singular_name' => _x( 'Field', 'taxonomy singular' ),
...
// Register the fields taxonomy

    register_taxonomy('fields',array('post'), array(
        'hierarchical' => true,
        'labels' => $labels,
        'show_ui' => true,
        'show_admin_column' => true,
